  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreactApp.codes.home.createOrEditLabel" data-cy="CodesCreateUpdateHeading">
            <Translate contentKey="hermesreactApp.codes.home.createOrEditLabel">Create or edit a Codes</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreactApp.codes.name')}
                id="codes-name"
                name="name"
                data-cy="name"
                type="text"
