...
export const CitizensRelationsDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hermesreactApp.citizensRelations.delete.question">
        <Translate contentKey="hermesreactApp.citizensRelations.delete.question" interpolate={{ id: citizensRelationsEntity.id }}>
