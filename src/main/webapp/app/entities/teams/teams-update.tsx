  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hermesreactApp.teams.home.createOrEditLabel" data-cy="TeamsCreateUpdateHeading">
            <Translate contentKey="hermesreactApp.teams.home.createOrEditLabel">Create or edit a Teams</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hermesreactApp.teams.name')}
                id="teams-name"
                name="name"
                data-cy="name"
                type="text"
