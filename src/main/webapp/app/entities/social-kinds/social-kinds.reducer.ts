...
const apiSearchUrl = 'api/_search/social-kinds';

// Actions

export const searchEntities = createAsyncThunk('socialKinds/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
