...
const apiSearchUrl = 'api/_search/marital-statuses';

// Actions

export const searchEntities = createAsyncThunk('maritalStatus/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
