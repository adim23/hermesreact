...
const apiSearchUrl = 'api/_search/social-contacts';

// Actions

export const searchEntities = createAsyncThunk('socialContacts/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
