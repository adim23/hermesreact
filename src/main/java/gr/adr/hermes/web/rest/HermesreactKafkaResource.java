...
@RestController
@RequestMapping("/api/hermesreact-kafka")
public class HermesreactKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HermesreactKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HermesreactKafkaResource(KafkaProperties kafkaProperties) {
